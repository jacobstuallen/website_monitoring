...
# Load z500
# ---------
fname= 'data/dewt.cfs.test.nc'
tds = xr.open_dataset(fname)['DPT_P0_2L108_GLL0'].sel(
        lat_0=slice(72,15),
        lon_0=slice(190,315))
...
#        "40916c","1b4332","52b788","e9d8a6",             # GREENS
#        "ffcb69","ee9b00","ca6702","ae2012","941b0c","621708",             # REDS
#        "370617","b5838d","e5989b","ffb4a2","ffcdb2"]             # PINKS

#color_hex_codes = [
#        "005f73","0a9396","94d2bd",             # BLUES
#        #"001219","005f73","0a9396","94d2bd",             # BLUES
#        #"d8f3dc","40916c","1b4332","52b788","e9d8a6",    # GREENS
#        "ee9b00","ca6702","9b2226","f4acb7"]    # REDS

color_hex_codes = ["f94144","f3722c","f8961e","f9c74f","90be6d","43aa8b","4d908e","edf6f9"][::-1]
...
ax.annotate('CFSv2.1 Dewpoint Temperature',
        (0.50,0.94),
        ha='center', va='bottom', 
        xycoords='figure fraction',
        fontsize=12, fontweight='bold')

ax.annotate('25 August, 2023',
        (0.50,0.905),
        ha='center', va='bottom', 
        xycoords='figure fraction',
        fontsize=10)
...
#plt.savefig('temp.test.png',  dpi=400)
plt.show()
